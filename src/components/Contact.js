const Contact = () => {
  return (
    <div
      id="contact"
      className="w-screen px-8 xl:px-[250px] 2xl:px-[450px] mb-[100px] lg:mt-[100px] flex flex-col items-center justify-center lg:flex-row gap-x-[100px] font-Montserrat">
      <img
