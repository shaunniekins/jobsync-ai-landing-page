...
const Footer = () => {
  return (
    <div className="w-screen bg-slate-900 px-[30px] md:px-[95px] pt-[30px] md:pt-[100px] pb-[20px] md:pb-[50px] font-Montserrat">
      ...
      <div className="flex flex-col md:flex-row justify-between">
        ...
        <div className="flex flex-col gap-y-[20px] md:gap-y-[50px] items-center md:items-start">
          <p className="text-white text-xl font-medium">
            Subscribe to our newsletter.
          </p>
          <form
            action=""
            className="flex flex-col md:flex-row gap-y-[10px] md:gap-y-0 md:gap-x-[25px] items-center md:items-start">
            <input
              type="email"
              className="w-[357.14px] h-[50px] flex rounded-[10px] border border-stone-300 text-stone-300 text-base font-normal outline-none pl-3 bg-transparent"
...
const renderColumn = (title, items) => (
  <div className="flex-col justify-start items-start gap-y-[18px] flex">
